...
class Pedido(models.Model):
    ...
    def clean(self):
        # CANDADOS DE SEGURIDAD (Multitenancy):
...
class DetallePedido(models.Model):
    # Conecta este detalle con su pedido padre (Ticket)
    pedido = models.ForeignKey(Pedido, on_delete=models.CASCADE, related_name='detalles')
    
    # Conecta con el catálogo de productos. 
    # on_delete=RESTRICT evita que borres del menú una "Pizza" si ya la vendiste alguna vez.
